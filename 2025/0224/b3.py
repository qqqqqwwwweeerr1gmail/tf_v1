...
class MotivationNN(nn.Module):
    ...
    def forward(self, x):
        ...
        # Scale output to 0-9 using sigmoid and multiply by 9
        scaled_output = torch.sigmoid(raw_output) * 9
        return scaled_output, control  # Return scaled output and control neurons
